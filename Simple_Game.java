 ...
 * @author rushl
 */
public class Simple_Game extends javax.swing.JFrame {

    private String startGame= "X";
    private int Count_x = 0;
    private int Count_o = 0;
    /**
     * Creates new form Simple_Game
     */
    public Simple_Game() {
        initComponents();
        setSize(1200,600);
    ...
    private void Score(){
        jlblPlayerX.setText(String.valueOf(Count_x));
        jlblPlayerO.setText(String.valueOf(Count_o));
    }
...
private JFrame frame;
    ...
    private void jbtnExitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtnExitActionPerformed
        ...
        if(JOptionPane.showConfirmDialog(frame, "Select if you want tou exit","Tic Tac Toe",
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Simple_Game.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
